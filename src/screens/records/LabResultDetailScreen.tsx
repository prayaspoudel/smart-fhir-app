...
type Props = NativeStackScreenProps<RecordsStackParamList, 'LabResultDetail'>;

const LabResultDetailScreen: React.FC<Props> = ({ route }) => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.id}>ID: {observationId}</Text>
          <Text style={styles.placeholder}>
            Detailed lab result information will be displayed here.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
